...
export default function DataSectionFive() {
  ...
  return (
    <section className="h-[620px] mt-16 relative flex items-center justify-around">
      <Image
      ...
      <article className=" grid grid-cols-2 grid-rows-2 gap-10 h-fit">
        {listSecfive.map((item, index) => {
          return (
            <div
              ...
              } w-[150px] h-[150px] rounded-2xl bg-orangeGrow-300 flex items-center justify-center shadow-shadowContainSecFive cursor-pointer transition-all duration-300 hover:border-2 hover:border-violetGrow-600 animate-animateBounceTwo `}
